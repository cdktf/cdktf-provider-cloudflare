...
# CDKTF prebuilt bindings for cloudflare/cloudflare provider version 4.50.0

This repo builds and publishes the [Terraform cloudflare provider](https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
- [Terraform cloudflare provider](https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0)
