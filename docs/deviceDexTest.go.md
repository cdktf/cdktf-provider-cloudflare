...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/devicedextest"
...
&devicedextest.DeviceDexTestConfig {
	...
	AccountId: *string,
	Data: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.deviceDexTest.DeviceDexTestData,
	Description: *string,
	Enabled: interface{},
	Interval: *string,
	Name: *string,
...
| <code><a href="#@cdktf/provider-cloudflare.deviceDexTest.DeviceDexTestConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.15.0/docs/resources/device_dex_test#id DeviceDexTest#id}. |
