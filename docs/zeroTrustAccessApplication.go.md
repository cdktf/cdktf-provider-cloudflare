...
```go
func InternalValue() ZeroTrustAccessApplicationScimConfigAuthentication
```
...
```go
func PutAuthentication(value ZeroTrustAccessApplicationScimConfigAuthentication)
```
...
```go
func Authentication() ZeroTrustAccessApplicationScimConfigAuthenticationOutputReference
```
...
```go
func AuthenticationInput() ZeroTrustAccessApplicationScimConfigAuthentication
```
