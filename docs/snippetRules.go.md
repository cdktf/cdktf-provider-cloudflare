...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/snippetrules"
...
| <code><a href="#@cdktf/provider-cloudflare.snippetRules.SnippetRulesRules.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.5.0/docs/resources/snippet_rules#enabled SnippetRules#enabled}. |
