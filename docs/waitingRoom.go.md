...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/waitingroom"
...
&waitingroom.WaitingRoomConfig {
	...
	CookieAttributes: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.waitingRoom.WaitingRoomCookieAttributes,
	CookieSuffix: *string,
...
| <code><a href="#@cdktf/provider-cloudflare.waitingRoom.WaitingRoomConfig.property.queueingStatusCode">QueueingStatusCode</a></code> | <code>*f64</code> | HTTP status code returned to a user while in the queue. |
