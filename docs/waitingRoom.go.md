...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/waitingroom"
...
&waitingroom.WaitingRoomConfig {
	...
	SessionDuration: *f64,
	Suspended: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.waitingRoom.WaitingRoomTimeouts,
}
```
