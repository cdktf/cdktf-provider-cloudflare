...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/list"
...
&list.ListItem {
	Value: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.list.ListItemValue,
	Comment: *string,
}
```
