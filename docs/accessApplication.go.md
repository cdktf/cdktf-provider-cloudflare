...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/accessapplication"
...
&accessapplication.AccessApplicationConfig {
	...
	Id: *string,
	LogoUrl: *string,
	SaasApp: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.accessApplication.AccessApplicationSaasApp,
