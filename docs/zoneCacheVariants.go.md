...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/zonecachevariants"
...
&zonecachevariants.ZoneCacheVariantsConfig {
	...
	Value: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zoneCacheVariants.ZoneCacheVariantsValue,
	ZoneId: *string,
}
```
