...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/zonecachevariants"
...
&zonecachevariants.ZoneCacheVariantsConfig {
	...
	Value: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.zoneCacheVariants.ZoneCacheVariantsValue,
	ZoneId: *string,
}
```
