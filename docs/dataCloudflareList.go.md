...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/datacloudflarelist"
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareList.DataCloudflareListConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.15.0/docs/data-sources/list#id DataCloudflareList#id}. |
