...
| <code><a href="#@cdktf/provider-cloudflare.zoneCacheReserve.ZoneCacheReserveConfig.property.value">Value</a></code> | <code>*string</code> | Value of the Cache Reserve zone setting. |
