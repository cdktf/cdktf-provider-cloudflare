...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/datacloudflaredevices"
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareDevices.DataCloudflareDevicesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.13.0/docs/data-sources/devices#id DataCloudflareDevices#id}. |
