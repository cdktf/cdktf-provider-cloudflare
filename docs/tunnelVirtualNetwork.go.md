...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7/tunnelvirtualnetwork"
...
| <code><a href="#@cdktf/provider-cloudflare.tunnelVirtualNetwork.TunnelVirtualNetworkConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/tunnel_virtual_network#id TunnelVirtualNetwork#id}. |
