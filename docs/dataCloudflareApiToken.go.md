...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/datacloudflareapitoken"
...
&datacloudflareapitoken.DataCloudflareApiTokenConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.dataCloudflareApiToken.DataCloudflareApiTokenFilter,
	TokenId: *string,
}
```
