...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7/teamsaccount"
...
&teamsaccount.TeamsAccountConfig {
	...
	Antivirus: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountAntivirus,
	BlockPage: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountBlockPage,
	Fips: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountFips,
	Id: *string,
	Logging: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountLogging,
	PayloadLog: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountPayloadLog,
	Proxy: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountProxy,
...
&teamsaccount.TeamsAccountLogging {
	RedactPii: interface{},
	SettingsByRuleType: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountLoggingSettingsByRuleType,
}
```
...
&teamsaccount.TeamsAccountLoggingSettingsByRuleType {
	Dns: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountLoggingSettingsByRuleTypeDns,
	Http: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountLoggingSettingsByRuleTypeHttp,
	L4: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.teamsAccount.TeamsAccountLoggingSettingsByRuleTypeL4,
}
```
