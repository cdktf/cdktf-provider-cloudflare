...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/devicemanagednetworks"
...
&devicemanagednetworks.DeviceManagedNetworksConfig {
	...
	AccountId: *string,
	Config: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.deviceManagedNetworks.DeviceManagedNetworksConfigA,
	Name: *string,
	Type: *string,
	Id: *string,
}
