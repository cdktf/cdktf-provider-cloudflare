...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/devicemanagednetworks"
...
&devicemanagednetworks.DeviceManagedNetworksConfig {
	...
	AccountId: *string,
	Config: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.deviceManagedNetworks.DeviceManagedNetworksConfigA,
	Name: *string,
	Type: *string,
	Id: *string,
}
