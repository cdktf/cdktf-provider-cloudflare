...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/zerotrustgatewaypolicy"
...
&zerotrustgatewaypolicy.ZeroTrustGatewayPolicyConfig {
	...
	Enabled: interface{},
	Expiration: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyExpiration,
	Filters: *[]*string,
	Identity: *string,
	Precedence: *f64,
	RuleSettings: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings,
	Schedule: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicySchedule,
	Traffic: *string,
}
```
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | True if the rule is enabled. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyConfig.property.precedence">Precedence</a></code> | <code>*f64</code> | Precedence sets the order of your rules. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyExpiration.property.duration">Duration</a></code> | <code>*f64</code> | The default duration a policy will be active in minutes. |
...
&zerotrustgatewaypolicy.ZeroTrustGatewayPolicyRuleSettings {
	...
	AuditSsh: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsAuditSsh,
	BisoAdminControls: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsBisoAdminControls,
	BlockPage: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsBlockPage,
	BlockPageEnabled: interface{},
	BlockReason: *string,
	BypassParentRule: interface{},
	CheckSession: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsCheckSession,
	DnsResolvers: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsDnsResolvers,
	Egress: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsEgress,
	...
	L4Override: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsL4Override,
	NotificationSettings: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsNotificationSettings,
	OverrideHost: *string,
	OverrideIps: *[]*string,
	PayloadLog: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsPayloadLog,
	Quarantine: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsQuarantine,
	Redirect: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsRedirect,
	ResolveDnsInternally: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsResolveDnsInternally,
	ResolveDnsThroughCloudflare: interface{},
	UntrustedCert: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsUntrustedCert,
}
```
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings.property.allowChildBypass">AllowChildBypass</a></code> | <code>interface{}</code> | Set by parent MSP accounts to enable their children to bypass this rule. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings.property.blockPageEnabled">BlockPageEnabled</a></code> | <code>interface{}</code> | Enable the custom block page. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings.property.bypassParentRule">BypassParentRule</a></code> | <code>interface{}</code> | Set by children MSP accounts to bypass their parent's rules. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings.property.insecureDisableDnssecValidation">InsecureDisableDnssecValidation</a></code> | <code>interface{}</code> | INSECURE - disable DNSSEC validation (for Allow actions). |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings.property.ipCategories">IpCategories</a></code> | <code>interface{}</code> | Set to true to enable IPs in DNS resolver category blocks. |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettings.property.ipIndicatorFeeds">IpIndicatorFeeds</a></code> | <code>interface{}</code> | Set to true to include IPs in DNS resolver indicator feed blocks. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsAuditSsh.property.commandLogging">CommandLogging</a></code> | <code>interface{}</code> | Enable to turn on SSH command logging. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsBlockPage.property.includeContext">IncludeContext</a></code> | <code>interface{}</code> | If true, context information will be passed as query parameters. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsCheckSession.property.enforce">Enforce</a></code> | <code>interface{}</code> | Set to true to enable session enforcement. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsDnsResolvers.property.ipv4">Ipv4</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_gateway_policy#ipv4 ZeroTrustGatewayPolicy#ipv4}. |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsDnsResolvers.property.ipv6">Ipv6</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.4.0/docs/resources/zero_trust_gateway_policy#ipv6 ZeroTrustGatewayPolicy#ipv6}. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4.property.port">Port</a></code> | <code>*f64</code> | A port number to use for upstream resolver. Defaults to 53 if unspecified. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv6.property.port">Port</a></code> | <code>*f64</code> | A port number to use for upstream resolver. Defaults to 53 if unspecified. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsL4Override.property.port">Port</a></code> | <code>*f64</code> | A port number to use for TCP/UDP overrides. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsNotificationSettings.property.enabled">Enabled</a></code> | <code>interface{}</code> | Set notification on. |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsNotificationSettings.property.includeContext">IncludeContext</a></code> | <code>interface{}</code> | If true, context information will be passed as query parameters. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsPayloadLog.property.enabled">Enabled</a></code> | <code>interface{}</code> | Set to true to enable DLP payload logging for this rule. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsRedirect.property.includeContext">IncludeContext</a></code> | <code>interface{}</code> | If true, context information will be passed as query parameters. |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustGatewayPolicy.ZeroTrustGatewayPolicyRuleSettingsRedirect.property.preservePathAndQuery">PreservePathAndQuery</a></code> | <code>interface{}</code> | If true, the path and query parameters from the original request will be appended to target_uri. |
