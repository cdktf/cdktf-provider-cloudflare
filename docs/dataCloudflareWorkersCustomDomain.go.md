...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflareworkerscustomdomain"
...
&datacloudflareworkerscustomdomain.DataCloudflareWorkersCustomDomainConfig {
	...
	AccountId: *string,
	DomainId: *string,
	Filter: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.dataCloudflareWorkersCustomDomain.DataCloudflareWorkersCustomDomainFilter,
}
```
