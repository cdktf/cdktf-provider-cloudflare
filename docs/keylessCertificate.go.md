...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/keylesscertificate"
...
Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/keyless_certificate#import import section} in the documentation of this resource for the id to use
...
&keylesscertificate.KeylessCertificateConfig {
	...
	Name: *string,
	Port: *f64,
	Tunnel: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.keylessCertificate.KeylessCertificateTunnel,
}
```
