...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v6/emailroutingcatchall"
...
| <code><a href="#@cdktf/provider-cloudflare.emailRoutingCatchAll.EmailRoutingCatchAllConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.4.0/docs/resources/email_routing_catch_all#id EmailRoutingCatchAll#id}. |
