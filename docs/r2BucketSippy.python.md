...
| <code><a href="#@cdktf/provider-cloudflare.r2BucketSippy.R2BucketSippySource.property.cloudProvider">cloud_provider</a></code> | <code>str</code> | Available values: "aws". |
