...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/accessrule"
...
| <code><a href="#@cdktf/provider-cloudflare.accessRule.AccessRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&accessrule.AccessRuleConfig {
	...
	Configuration: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.accessRule.AccessRuleConfiguration,
	Mode: *string,
	AccountId: *string,
	Id: *string,
	Notes: *string,
...
| <code><a href="#@cdktf/provider-cloudflare.accessRule.AccessRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
