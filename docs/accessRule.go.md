...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/accessrule"
...
&accessrule.AccessRuleConfig {
	...
	Configuration: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.accessRule.AccessRuleConfiguration,
	Mode: *string,
	AccountId: *string,
	Id: *string,
	Notes: *string,
