...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7/accessrule"
...
&accessrule.AccessRuleConfig {
	...
	Configuration: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.accessRule.AccessRuleConfiguration,
	Mode: *string,
	AccountId: *string,
	Id: *string,
	Notes: *string,
