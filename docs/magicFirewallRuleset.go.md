...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v10/magicfirewallruleset"
...
| <code><a href="#@cdktf/provider-cloudflare.magicFirewallRuleset.MagicFirewallRulesetConfig.property.rules">Rules</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/magic_firewall_ruleset#rules MagicFirewallRuleset#rules}. |
