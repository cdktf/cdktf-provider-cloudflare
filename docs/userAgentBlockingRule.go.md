...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7/useragentblockingrule"
...
&useragentblockingrule.UserAgentBlockingRuleConfig {
	...
	Configuration: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.userAgentBlockingRule.UserAgentBlockingRuleConfiguration,
	Description: *string,
	Mode: *string,
	Paused: interface{},
	ZoneId: *string,
...
| <code><a href="#@cdktf/provider-cloudflare.userAgentBlockingRule.UserAgentBlockingRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/user_agent_blocking_rule#id UserAgentBlockingRule#id}. |
