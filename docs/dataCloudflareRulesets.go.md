...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflarerulesets"
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareRulesets.DataCloudflareRulesetsConfig.property.maxItems">MaxItems</a></code> | <code>*f64</code> | Maximum number of rulesets to fetch (defaults to 1000). |
