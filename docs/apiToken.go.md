...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/apitoken"
...
| <code><a href="#@cdktf/provider-cloudflare.apiToken.ApiToken.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&apitoken.ApiTokenCondition {
	RequestIp: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.apiToken.ApiTokenConditionRequestIp,
}
```
...
&apitoken.ApiTokenConfig {
	...
	Name: *string,
	Policy: interface{},
	Condition: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.apiToken.ApiTokenCondition,
	ExpiresOn: *string,
	Id: *string,
	NotBefore: *string,
}
...
| <code><a href="#@cdktf/provider-cloudflare.apiToken.ApiTokenConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
