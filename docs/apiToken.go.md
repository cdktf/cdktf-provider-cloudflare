...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7/apitoken"
...
&apitoken.ApiTokenCondition {
	RequestIp: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.apiToken.ApiTokenConditionRequestIp,
}
```
...
&apitoken.ApiTokenConfig {
	...
	Name: *string,
	Policy: interface{},
	Condition: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.apiToken.ApiTokenCondition,
	ExpiresOn: *string,
	Id: *string,
	NotBefore: *string,
}
