...
##### `cfRobotsVariant`<sup>Optional</sup> <a name="cfRobotsVariant" id="@cdktf/provider-cloudflare.botManagement.BotManagement.Initializer.parameter.cfRobotsVariant"></a>
