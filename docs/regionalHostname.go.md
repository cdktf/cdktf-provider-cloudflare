...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v6/regionalhostname"
...
&regionalhostname.RegionalHostnameConfig {
	...
	ZoneId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v6.regionalHostname.RegionalHostnameTimeouts,
}
```
