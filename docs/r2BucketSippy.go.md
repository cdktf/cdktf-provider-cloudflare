...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/r2bucketsippy"
...
&r2bucketsippy.R2BucketSippyConfig {
	...
	AccountId: *string,
	BucketName: *string,
	Destination: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.r2BucketSippy.R2BucketSippyDestination,
	Jurisdiction: *string,
	Source: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.r2BucketSippy.R2BucketSippySource,
}
```
