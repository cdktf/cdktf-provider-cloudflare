...
| <code><a href="#@cdktf/provider-cloudflare.staticRoute.StaticRoute.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.19.0/docs/resources/static_route#id StaticRoute#id}. |
...
##### `add_move_target` <a name="add_move_target" id="@cdktf/provider-cloudflare.staticRoute.StaticRoute.addMoveTarget"></a>
...
| <code><a href="#@cdktf/provider-cloudflare.staticRoute.StaticRouteConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.19.0/docs/resources/static_route#id StaticRoute#id}. |
