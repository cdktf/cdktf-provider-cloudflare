...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/authenticatedoriginpullscertificate"
...
&authenticatedoriginpullscertificate.AuthenticatedOriginPullsCertificateConfig {
	...
	ZoneId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.authenticatedOriginPullsCertificate.AuthenticatedOriginPullsCertificateTimeouts,
}
```
