...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/authenticatedoriginpullscertificate"
...
| <code><a href="#@cdktf/provider-cloudflare.authenticatedOriginPullsCertificate.AuthenticatedOriginPullsCertificate.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&authenticatedoriginpullscertificate.AuthenticatedOriginPullsCertificateConfig {
	...
	ZoneId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.authenticatedOriginPullsCertificate.AuthenticatedOriginPullsCertificateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-cloudflare.authenticatedOriginPullsCertificate.AuthenticatedOriginPullsCertificateConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
