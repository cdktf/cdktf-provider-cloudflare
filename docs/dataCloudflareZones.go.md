...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/datacloudflarezones"
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareZones.DataCloudflareZones.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datacloudflarezones.DataCloudflareZonesConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.dataCloudflareZones.DataCloudflareZonesFilter,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareZones.DataCloudflareZonesConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareZones.DataCloudflareZonesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/d/zones#id DataCloudflareZones#id}. |
