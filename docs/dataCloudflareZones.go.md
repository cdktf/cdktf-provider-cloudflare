...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/datacloudflarezones"
...
&datacloudflarezones.DataCloudflareZonesConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.dataCloudflareZones.DataCloudflareZonesFilter,
	Id: *string,
}
```
