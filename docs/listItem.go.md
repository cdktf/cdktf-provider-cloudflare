...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/listitem"
...
&listitem.ListItemAConfig {
	...
	Asn: *f64,
	Comment: *string,
	Hostname: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.listItem.ListItemHostname,
	Id: *string,
	Ip: *string,
	Redirect: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.listItem.ListItemRedirect,
}
```
