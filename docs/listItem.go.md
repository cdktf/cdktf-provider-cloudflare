...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/listitem"
...
&listitem.ListItemAConfig {
	...
	Asn: *f64,
	Comment: *string,
	Hostname: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.listItem.ListItemHostname,
	Id: *string,
	Ip: *string,
	Redirect: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.listItem.ListItemRedirect,
}
```
...
| <code><a href="#@cdktf/provider-cloudflare.listItem.ListItemAConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.13.0/docs/resources/list_item#id ListItemA#id}. |
