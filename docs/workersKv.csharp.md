...
| <code><a href="#@cdktf/provider-cloudflare.workersKv.WorkersKvConfig.property.metadata">Metadata</a></code> | <code>string</code> | Arbitrary JSON to be associated with a key/value pair. |
