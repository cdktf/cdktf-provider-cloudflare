...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/snippets"
...
&snippets.SnippetsConfig {
	...
	Files: *[]*string,
	Metadata: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.snippets.SnippetsMetadata,
	SnippetName: *string,
	ZoneId: *string,
}
```
