...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/tunnelconfig"
...
&tunnelconfig.TunnelConfigConfig {
	...
	AccountId: *string,
	Config: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.tunnelConfig.TunnelConfigConfigA,
	TunnelId: *string,
	Id: *string,
}
```
...
&tunnelconfig.TunnelConfigConfigA {
	...
	OriginRequest: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.tunnelConfig.TunnelConfigConfigOriginRequest,
	WarpRouting: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.tunnelConfig.TunnelConfigConfigWarpRouting,
}
```
