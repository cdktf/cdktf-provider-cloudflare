...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflarecustomhostname"
...
&datacloudflarecustomhostname.DataCloudflareCustomHostnameConfig {
	...
	Filter: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.dataCloudflareCustomHostname.DataCloudflareCustomHostnameFilter,
}
```
