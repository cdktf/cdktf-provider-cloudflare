...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/tokenvalidationrules"
...
&tokenvalidationrules.TokenValidationRulesConfig {
	...
	Enabled: interface{},
	Expression: *string,
	Selector: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare.tokenValidationRules.TokenValidationRulesSelector,
	Title: *string,
	ZoneId: *string,
	Position: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare.tokenValidationRules.TokenValidationRulesPosition,
}
```
