...
```typescript
import { dataCloudflareApiTokenPermissionsGroups } from '@cdktf/provider-cloudflare'

new dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups(scope: Construct, id: string, config: DataCloudflareApiTokenPermissionsGroupsConfig)
```
...
dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.isConstruct(x: any)
```
...
dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.isTerraformElement(x: any)
```
...
dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.isTerraformDataSource(x: any)
```
...
dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroups.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
const dataCloudflareApiTokenPermissionsGroupsConfig: dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroupsConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroupsConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroupsConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroupsConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroupsConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareApiTokenPermissionsGroups.DataCloudflareApiTokenPermissionsGroupsConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
