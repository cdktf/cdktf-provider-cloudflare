...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/datacloudflareaccounts"
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareAccounts.DataCloudflareAccountsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.12.0/docs/data-sources/accounts#id DataCloudflareAccounts#id}. |
