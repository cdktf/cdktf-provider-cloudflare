...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/ratelimit"
...
&ratelimit.RateLimitAction {
	Mode: *string,
	Response: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.rateLimit.RateLimitActionResponse,
	Timeout: *f64,
}
```
...
&ratelimit.RateLimitConfig {
	...
	Action: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.rateLimit.RateLimitAction,
	Period: *f64,
	Threshold: *f64,
	ZoneId: *string,
	BypassUrlPatterns: *[]*string,
	Correlate: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.rateLimit.RateLimitCorrelate,
	Description: *string,
	Disabled: interface{},
	Id: *string,
	Match: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.rateLimit.RateLimitMatch,
}
```
...
&ratelimit.RateLimitMatch {
	Request: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.rateLimit.RateLimitMatchRequest,
	Response: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.rateLimit.RateLimitMatchResponse,
}
```
