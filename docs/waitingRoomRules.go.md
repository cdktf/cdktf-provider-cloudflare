...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/waitingroomrules"
...
| <code><a href="#@cdktf/provider-cloudflare.waitingRoomRules.WaitingRoomRulesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.13.0/docs/resources/waiting_room_rules#id WaitingRoomRules#id}. |
