...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/r2bucketcors"
...
| <code><a href="#@cdktf/provider-cloudflare.r2BucketCors.R2BucketCorsConfig.property.rules">Rules</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/r2_bucket_cors#rules R2BucketCors#rules}. |
...
&r2bucketcors.R2BucketCorsRules {
	Allowed: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare.r2BucketCors.R2BucketCorsRulesAllowed,
...
| <code><a href="#@cdktf/provider-cloudflare.r2BucketCors.R2BucketCorsRulesAllowedOutputReference.property.internalValue">InternalValue</a></code> | <code><a href="#@cdktf/provider-cloudflare.r2BucketCors.R2BucketCorsRulesAllowed">R2BucketCorsRulesAllowed</a></code> | *No description.* |
...
```go
func InternalValue() R2BucketCorsRulesAllowed
```
...
| <code><a href="#@cdktf/provider-cloudflare.r2BucketCors.R2BucketCorsRulesOutputReference.property.allowedInput">AllowedInput</a></code> | <code><a href="#@cdktf/provider-cloudflare.r2BucketCors.R2BucketCorsRulesAllowed">R2BucketCorsRulesAllowed</a></code> | *No description.* |
...
```go
func AllowedInput() R2BucketCorsRulesAllowed
```
