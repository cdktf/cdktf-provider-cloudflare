...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/r2bucketcors"
...
| <code><a href="#@cdktf/provider-cloudflare.r2BucketCors.R2BucketCorsConfig.property.rules">Rules</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.10.1/docs/resources/r2_bucket_cors#rules R2BucketCors#rules}. |
...
&r2bucketcors.R2BucketCorsRules {
	Allowed: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.r2BucketCors.R2BucketCorsRulesAllowed,
