...
```csharp
private void ResetAuthIdCharacteristics()
```
...
new ApiShieldConfig {
    ...
    string ZoneId,
    object AuthIdCharacteristics = null,
    string Id = null
};
```
...
| <code><a href="#@cdktf/provider-cloudflare.apiShield.ApiShieldConfig.property.authIdCharacteristics">AuthIdCharacteristics</a></code> | <code>object</code> | auth_id_characteristics block. |
| <code><a href="#@cdktf/provider-cloudflare.apiShield.ApiShieldConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.19.0/docs/resources/api_shield#id ApiShield#id}. |
