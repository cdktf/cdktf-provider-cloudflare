...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/spectrumapplication"
...
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplication.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
```go
func EdgeIpConnectivityInput() *string
```
...
```go
func EdgeIpConnectivity() *string
```
...
&spectrumapplication.SpectrumApplicationConfig {
	...
	Dns: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.spectrumApplication.SpectrumApplicationDns,
	Protocol: *string,
	ZoneId: *string,
	...
	OriginDirect: *[]*string,
	OriginDns: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.spectrumApplication.SpectrumApplicationOriginDns,
	OriginPort: *f64,
	OriginPortRange: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.spectrumApplication.SpectrumApplicationOriginPortRange,
...
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationConfig.property.argoSmartRouting">ArgoSmartRouting</a></code> | <code>interface{}</code> | Enables Argo Smart Routing. Defaults to `false`. |
...
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationConfig.property.ipFirewall">IpFirewall</a></code> | <code>interface{}</code> | Enables the IP Firewall for this application. Defaults to `true`. |
...
```go
func InternalValue() SpectrumApplicationOriginDns
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationOriginPortRangeOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationOriginPortRangeOutputReference.property.endInput">EndInput</a></code> | <code>*f64</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationOriginPortRangeOutputReference.property.startInput">StartInput</a></code> | <code>*f64</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationOriginPortRangeOutputReference.property.end">End</a></code> | <code>*f64</code> | *No description.* |
| <code><a href="#@cdktf/provider-cloudflare.spectrumApplication.SpectrumApplicationOriginPortRangeOutputReference.property.start">Start</a></code> | <code>*f64</code> | *No description.* |
...
```go
func InternalValue() SpectrumApplicationOriginPortRange
```
