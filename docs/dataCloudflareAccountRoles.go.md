...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/datacloudflareaccountroles"
...
| <code><a href="#@cdktf/provider-cloudflare.dataCloudflareAccountRoles.DataCloudflareAccountRolesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.10.0/docs/data-sources/account_roles#id DataCloudflareAccountRoles#id}. |
