...
| <code><a href="#@cdktf/provider-cloudflare.snippet.Snippet.Initializer.parameter.files">files</a></code> | <code>com.hashicorp.cdktf.IResolvable OR java.util.List<<a href="#@cdktf/provider-cloudflare.snippet.SnippetFiles">SnippetFiles</a>></code> | The list of files belonging to the snippet. |
...
| <code><a href="#@cdktf/provider-cloudflare.snippet.Snippet.property.metadataInput">metadataInput</a></code> | <code>com.hashicorp.cdktf.IResolvable OR <a href="#@cdktf/provider-cloudflare.snippet.SnippetMetadata">SnippetMetadata</a></code> | *No description.* |
...
- *Type:* com.hashicorp.cdktf.IResolvable OR <a href="#@cdktf/provider-cloudflare.snippet.SnippetMetadata">SnippetMetadata</a>
...
| <code><a href="#@cdktf/provider-cloudflare.snippet.SnippetConfig.property.files">files</a></code> | <code>com.hashicorp.cdktf.IResolvable OR java.util.List<<a href="#@cdktf/provider-cloudflare.snippet.SnippetFiles">SnippetFiles</a>></code> | The list of files belonging to the snippet. |
...
| <code><a href="#@cdktf/provider-cloudflare.snippet.SnippetMetadataOutputReference.property.internalValue">internalValue</a></code> | <code>com.hashicorp.cdktf.IResolvable OR <a href="#@cdktf/provider-cloudflare.snippet.SnippetMetadata">SnippetMetadata</a></code> | *No description.* |
