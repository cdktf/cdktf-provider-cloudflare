...
| <code><a href="#@cdktf/provider-cloudflare.filter.FilterConfig.property.body">Body</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.9.0/docs/resources/filter#body Filter#body}. |
