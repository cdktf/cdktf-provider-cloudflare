...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/cloudconnectorrules"
...
| <code><a href="#@cdktf/provider-cloudflare.cloudConnectorRules.CloudConnectorRulesConfig.property.rules">Rules</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.10.1/docs/resources/cloud_connector_rules#rules CloudConnectorRules#rules}. |
...
&cloudconnectorrules.CloudConnectorRulesRules {
	...
	Enabled: interface{},
	Expression: *string,
	Parameters: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.cloudConnectorRules.CloudConnectorRulesRulesParameters,
	Provider: *string,
}
```
...
| <code><a href="#@cdktf/provider-cloudflare.cloudConnectorRules.CloudConnectorRulesRules.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.10.1/docs/resources/cloud_connector_rules#enabled CloudConnectorRules#enabled}. |
