...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/customssl"
...
&customssl.CustomSslConfig {
	...
	ZoneId: *string,
	BundleMethod: *string,
	GeoRestrictions: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.customSsl.CustomSslGeoRestrictions,
	Policy: *string,
	Type: *string,
}
```
