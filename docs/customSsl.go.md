...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7/customssl"
...
&customssl.CustomSslConfig {
	...
	ZoneId: *string,
	CustomSslOptions: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v7.customSsl.CustomSslCustomSslOptions,
