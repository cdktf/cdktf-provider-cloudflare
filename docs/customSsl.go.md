...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5/customssl"
...
&customssl.CustomSslConfig {
	...
	ZoneId: *string,
	CustomSslOptions: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v5.customSsl.CustomSslCustomSslOptions,
