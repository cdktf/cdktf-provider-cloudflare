...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/waitingroomevent"
...
| <code><a href="#@cdktf/provider-cloudflare.waitingRoomEvent.WaitingRoomEventConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.13.0/docs/resources/waiting_room_event#id WaitingRoomEvent#id}. |
