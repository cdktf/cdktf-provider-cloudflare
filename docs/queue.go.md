...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/queue"
...
&queue.QueueConfig {
	...
	AccountId: *string,
	QueueName: *string,
	Settings: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13.queue.QueueSettings,
}
```
