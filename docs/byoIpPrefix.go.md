...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/byoipprefix"
...
| <code><a href="#@cdktf/provider-cloudflare.byoIpPrefix.ByoIpPrefixConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.14.0/docs/resources/byo_ip_prefix#id ByoIpPrefix#id}. |
