...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8/loadbalancer"
...
&loadbalancer.LoadBalancerRules {
	...
	Condition: *string,
	Disabled: interface{},
	FixedResponse: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v8.loadBalancer.LoadBalancerRulesFixedResponse,
	Overrides: interface{},
	Priority: *f64,
