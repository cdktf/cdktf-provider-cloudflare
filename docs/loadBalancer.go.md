...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/loadbalancer"
...
&loadbalancer.LoadBalancerRules {
	...
	Condition: *string,
	Disabled: interface{},
	FixedResponse: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9.loadBalancer.LoadBalancerRulesFixedResponse,
	Overrides: interface{},
	Priority: *f64,
