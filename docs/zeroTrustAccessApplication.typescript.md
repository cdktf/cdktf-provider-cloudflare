...
```typescript
public readonly l4Protocol: string;
```
...
```typescript
public readonly authentication: IResolvable | ZeroTrustAccessApplicationScimConfigAuthentication[];
```
...
```typescript
public readonly l4ProtocolInput: string;
```
...
new zeroTrustAccessApplication.ZeroTrustAccessApplicationScimConfigAuthenticationList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationScimConfigAuthenticationList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationScimConfigAuthenticationList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | ZeroTrustAccessApplicationScimConfigAuthentication[];
```
...
new zeroTrustAccessApplication.ZeroTrustAccessApplicationScimConfigAuthenticationOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationScimConfigAuthenticationOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public putAuthentication(value: IResolvable | ZeroTrustAccessApplicationScimConfigAuthentication[]): void
```
...
```typescript
public readonly authentication: ZeroTrustAccessApplicationScimConfigAuthenticationList;
```
...
```typescript
public readonly authenticationInput: IResolvable | ZeroTrustAccessApplicationScimConfigAuthentication[];
```
