...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v9/mtlscertificate"
...
| <code><a href="#@cdktf/provider-cloudflare.mtlsCertificate.MtlsCertificateConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.13.0/docs/resources/mtls_certificate#id MtlsCertificate#id}. |
