...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/zerotrustdevicesettings"
...
```go
func ResetExternalEmergencySignalEnabled()
```
...
```go
func ResetExternalEmergencySignalFingerprint()
```
...
```go
func ResetExternalEmergencySignalInterval()
```
...
```go
func ResetExternalEmergencySignalUrl()
```
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustDeviceSettings.ZeroTrustDeviceSettings.property.externalEmergencySignalEnabledInput">ExternalEmergencySignalEnabledInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustDeviceSettings.ZeroTrustDeviceSettings.property.externalEmergencySignalEnabled">ExternalEmergencySignalEnabled</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func ExternalEmergencySignalEnabledInput() interface{}
```
...
```go
func ExternalEmergencySignalFingerprintInput() *string
```
...
```go
func ExternalEmergencySignalIntervalInput() *string
```
...
```go
func ExternalEmergencySignalUrlInput() *string
```
...
```go
func ExternalEmergencySignalEnabled() interface{}
```
...
| <code><a href="#@cdktf/provider-cloudflare.zeroTrustDeviceSettings.ZeroTrustDeviceSettingsConfig.property.externalEmergencySignalEnabled">ExternalEmergencySignalEnabled</a></code> | <code>interface{}</code> | Controls whether the external emergency disconnect feature is enabled. |
