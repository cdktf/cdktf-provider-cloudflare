...
```go
import "github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/datacloudflareapishieldoperation"
...
&datacloudflareapishieldoperation.DataCloudflareApiShieldOperationConfig {
	...
	ZoneId: *string,
	Feature: *[]*string,
	Filter: github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare.dataCloudflareApiShieldOperation.DataCloudflareApiShieldOperationFilter,
	OperationId: *string,
}
```
