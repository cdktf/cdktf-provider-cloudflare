...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-cloudflare.r2BucketLifecycle.R2BucketLifecycleRulesAbortMultipartUploadsTransitionCondition.property.maxAge">maxAge</a></code> | <code>number</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/r2_bucket_lifecycle#max_age R2BucketLifecycle#max_age}. |
...
```typescript
public readonly internalValue: R2BucketLifecycleRulesConditions;
```
...
```typescript
public readonly conditionsInput: R2BucketLifecycleRulesConditions;
```
...
```typescript
public readonly internalValue: R2BucketLifecycleRulesStorageClassTransitionsCondition;
```
...
```typescript
public readonly conditionInput: R2BucketLifecycleRulesStorageClassTransitionsCondition;
```
