// https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/magic_firewall_ruleset
...
export class MagicFirewallRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MagicFirewallRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/magic_firewall_ruleset#import import section} in the documentation of this resource for the id to use
