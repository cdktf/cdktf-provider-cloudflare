...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.6.0/docs/resources/zero_trust_gateway_settings
...
export function zeroTrustGatewaySettingsSettingsAppControlSettingsToTerraform(struct?: ZeroTrustGatewaySettingsSettingsAppControlSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function zeroTrustGatewaySettingsSettingsAppControlSettingsToHclTerraform(struct?: ZeroTrustGatewaySettingsSettingsAppControlSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ZeroTrustGatewaySettingsSettingsAppControlSettingsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ZeroTrustGatewaySettingsSettingsAppControlSettings | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ZeroTrustGatewaySettingsSettingsAppControlSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._enabled = undefined;
...
export interface ZeroTrustGatewaySettingsSettings {
  ...
  */
  readonly appControlSettings?: ZeroTrustGatewaySettingsSettingsAppControlSettings;
  /**
...
export function zeroTrustGatewaySettingsSettingsToTerraform(struct?: ZeroTrustGatewaySettingsSettings | cdktf.IResolvable): any {
  ...
  return {
    ...
    app_control_settings: zeroTrustGatewaySettingsSettingsAppControlSettingsToTerraform(struct!.appControlSettings),
...
export function zeroTrustGatewaySettingsSettingsToHclTerraform(struct?: ZeroTrustGatewaySettingsSettings | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    app_control_settings: {
      value: zeroTrustGatewaySettingsSettingsAppControlSettingsToHclTerraform(struct!.appControlSettings),
      isBlock: true,
      type: "struct",
      storageClassType: "ZeroTrustGatewaySettingsSettingsAppControlSettings",
    },
    block_page: {
...
export class ZeroTrustGatewaySettingsSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZeroTrustGatewaySettingsSettings | cdktf.IResolvable | undefined {
    ...
    if (this._appControlSettings?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.appControlSettings = this._appControlSettings?.internalValue;
    }
  ...
  public set internalValue(value: ZeroTrustGatewaySettingsSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._appControlSettings.internalValue = undefined;
      ...
      this._appControlSettings.internalValue = value.appControlSettings;
  ...
  // app_control_settings - computed: true, optional: true, required: false
  private _appControlSettings = new ZeroTrustGatewaySettingsSettingsAppControlSettingsOutputReference(this, "app_control_settings");
  public get appControlSettings() {
    return this._appControlSettings;
  }
  public putAppControlSettings(value: ZeroTrustGatewaySettingsSettingsAppControlSettings) {
    this._appControlSettings.internalValue = value;
  }
  public resetAppControlSettings() {
    this._appControlSettings.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get appControlSettingsInput() {
    return this._appControlSettings.internalValue;
  }
  ...
  // host_selector - computed: true, optional: true, required: false
...
export class ZeroTrustGatewaySettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustGatewaySettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.6.0/docs/resources/zero_trust_gateway_settings#import import section} in the documentation of this resource for the id to use
