...
export class DlpProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlpProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.22.0/docs/resources/dlp_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.22.0/docs/resources/dlp_profile cloudflare_dlp_profile} Resource
  *
  * @param scope The scope in which to define this construct
