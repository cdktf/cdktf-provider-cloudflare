// https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_address
...
export class EmailRoutingAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailRoutingAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_address#import import section} in the documentation of this resource for the id to use
