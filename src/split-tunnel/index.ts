// https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel
...
export interface SplitTunnelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#account_id SplitTunnel#account_id}
  */
  readonly accountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#id SplitTunnel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#mode SplitTunnel#mode}
  */
  readonly mode: string;
  /**
  * The settings policy for which to configure this split tunnel policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#policy_id SplitTunnel#policy_id}
  */
  readonly policyId?: string;
  /**
  * tunnels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#tunnels SplitTunnel#tunnels}
  */
...
export interface SplitTunnelTunnels {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#address SplitTunnel#address}
  */
  readonly address?: string;
  /**
  * A description for the tunnel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#description SplitTunnel#description}
  */
  readonly description?: string;
  /**
  * The domain name for the tunnel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#host SplitTunnel#host}
  */
...
export class SplitTunnel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SplitTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.21.0/docs/resources/split_tunnel#import import section} in the documentation of this resource for the id to use
