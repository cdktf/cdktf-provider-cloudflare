// https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/snippets
...
export class SnippetsMetadataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // main_module - computed: true, optional: true, required: false
...
export class Snippets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Snippets that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/snippets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      files: cdktf.stringToTerraform(this._files),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      files: {
        value: cdktf.stringToHclTerraform(this._files),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
