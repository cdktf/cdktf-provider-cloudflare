...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.31.0/docs/resources/tunnel_route
...
export class TunnelRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TunnelRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.31.0/docs/resources/tunnel_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.31.0/docs/resources/tunnel_route cloudflare_tunnel_route} Resource
  *
  * @param scope The scope in which to define this construct
