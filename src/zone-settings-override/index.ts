// https://registry.terraform.io/providers/cloudflare/cloudflare/4.24.0/docs/resources/zone_settings_override
...
export class ZoneSettingsOverride extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZoneSettingsOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.24.0/docs/resources/zone_settings_override#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.24.0/docs/resources/zone_settings_override cloudflare_zone_settings_override} Resource
  *
  * @param scope The scope in which to define this construct
