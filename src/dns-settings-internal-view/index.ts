// https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/dns_settings_internal_view
...
export interface DnsSettingsInternalViewConfig extends cdktf.TerraformMetaArguments {
  /**
  * Identifier
  *
...
*/
export class DnsSettingsInternalView extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the DnsSettingsInternalView to import
  * @param importFromId The id of the existing DnsSettingsInternalView that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/dns_settings_internal_view#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DnsSettingsInternalView to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/dns_settings_internal_view cloudflare_dns_settings_internal_view} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DnsSettingsInternalViewConfig
  */
  public constructor(scope: Construct, id: string, config: DnsSettingsInternalViewConfig) {
    super(scope, id, {
