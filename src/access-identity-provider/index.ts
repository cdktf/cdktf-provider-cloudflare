// https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/access_identity_provider
...
export function accessIdentityProviderConfigAToHclTerraform(struct?: AccessIdentityProviderConfigA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function accessIdentityProviderScimConfigToHclTerraform(struct?: AccessIdentityProviderScimConfig | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AccessIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the AccessIdentityProvider to import
  * @param importFromId The id of the existing AccessIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/access_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      config: {
        value: cdktf.listMapperHcl(accessIdentityProviderConfigAToHclTerraform, true)(this._config.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AccessIdentityProviderConfigAList",
      },
      scim_config: {
        value: cdktf.listMapperHcl(accessIdentityProviderScimConfigToHclTerraform, true)(this._scimConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AccessIdentityProviderScimConfigList",
      },
    };
