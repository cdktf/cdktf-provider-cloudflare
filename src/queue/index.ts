...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue
...
export interface QueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#account_id Queue#account_id}
  */
  readonly accountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#queue_name Queue#queue_name}
  */
  readonly queueName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#settings Queue#settings}
  */
...
export interface QueueSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#delivery_delay Queue#delivery_delay}
  */
  readonly deliveryDelay?: number;
  /**
  * Indicates if message delivery to consumers is currently paused.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#delivery_paused Queue#delivery_paused}
  */
  readonly deliveryPaused?: boolean | cdktf.IResolvable;
  /**
  * Number of seconds after which an unconsumed message will be delayed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#message_retention_period Queue#message_retention_period}
  */
...
export class QueueSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _deliveryPaused?: boolean | cdktf.IResolvable; 
  public get deliveryPaused() {
    return this.getBooleanAttribute('delivery_paused');
  }
  public set deliveryPaused(value: boolean | cdktf.IResolvable) {
    this._deliveryPaused = value;
  }
  public resetDeliveryPaused() {
    this._deliveryPaused = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get deliveryPausedInput() {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue cloudflare_queue}
*/
export class Queue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Queue that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/queue cloudflare_queue} Resource
  *
  * @param scope The scope in which to define this construct
