// https://registry.terraform.io/providers/cloudflare/cloudflare/4.36.0/docs/resources/teams_account
...
export class TeamsAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.36.0/docs/resources/teams_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.36.0/docs/resources/teams_account cloudflare_teams_account} Resource
  *
  * @param scope The scope in which to define this construct
