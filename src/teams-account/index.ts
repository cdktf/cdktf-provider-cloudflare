// https://registry.terraform.io/providers/cloudflare/cloudflare/4.49.0/docs/resources/teams_account
...
export interface TeamsAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly certificate?: TeamsAccountCertificate;
  /**
...
export function teamsAccountCertificateToTerraform(struct?: TeamsAccountCertificateOutputReference | TeamsAccountCertificate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function teamsAccountCertificateToHclTerraform(struct?: TeamsAccountCertificateOutputReference | TeamsAccountCertificate): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TeamsAccountCertificateOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): TeamsAccountCertificate | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: TeamsAccountCertificate | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
    }
...
export class TeamsAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.49.0/docs/resources/teams_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.49.0/docs/resources/teams_account cloudflare_teams_account} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _certificate = new TeamsAccountCertificateOutputReference(this, "certificate");
  public get certificate() {
    return this._certificate;
  }
  public putCertificate(value: TeamsAccountCertificate) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      certificate: teamsAccountCertificateToTerraform(this._certificate.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      certificate: {
        value: teamsAccountCertificateToHclTerraform(this._certificate.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "TeamsAccountCertificateList",
      },
      custom_certificate: {
