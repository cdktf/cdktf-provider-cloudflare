...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/argo
...
export class Argo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Argo that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/argo#import import section} in the documentation of this resource for the id to use
