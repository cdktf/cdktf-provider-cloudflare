// https://registry.terraform.io/providers/cloudflare/cloudflare/5.5.0/docs/resources/argo_tiered_caching
...
export class ArgoTieredCaching extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArgoTieredCaching that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.5.0/docs/resources/argo_tiered_caching#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.5.0/docs/resources/argo_tiered_caching cloudflare_argo_tiered_caching} Resource
  *
  * @param scope The scope in which to define this construct
