...
export class IpListItemOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IpListItem | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IpListItem | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IpListItemList extends cdktf.ComplexList {
  public internalValue? : IpListItem[] | cdktf.IResolvable
  ...
  */
  public get(index: number): IpListItemOutputReference {
    return new IpListItemOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class IpList extends cdktf.TerraformResource {
  ...
  */
  ...
  private _item = new IpListItemList(this, "item", true);
  public get item() {
    return this._item;
  }
  public putItem(value: IpListItem[] | cdktf.IResolvable) {
