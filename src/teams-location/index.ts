...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.19.0/docs/resources/teams_location
...
export class TeamsLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamsLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.19.0/docs/resources/teams_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.19.0/docs/resources/teams_location cloudflare_teams_location} Resource
  *
  * @param scope The scope in which to define this construct
