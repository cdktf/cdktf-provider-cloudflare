...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/data-sources/dns_settings_internal_views
...
export interface DataCloudflareDnsSettingsInternalViewsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Identifier
  *
  ...
  */
  readonly name?: DataCloudflareDnsSettingsInternalViewsName;
  /**
...
export interface DataCloudflareDnsSettingsInternalViewsName {
  /**
...
export function dataCloudflareDnsSettingsInternalViewsNameToTerraform(struct?: DataCloudflareDnsSettingsInternalViewsName | cdktf.IResolvable): any {
...
export function dataCloudflareDnsSettingsInternalViewsNameToHclTerraform(struct?: DataCloudflareDnsSettingsInternalViewsName | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareDnsSettingsInternalViewsNameOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareDnsSettingsInternalViewsName | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareDnsSettingsInternalViewsName | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface DataCloudflareDnsSettingsInternalViewsResult {
}

export function dataCloudflareDnsSettingsInternalViewsResultToTerraform(struct?: DataCloudflareDnsSettingsInternalViewsResult): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataCloudflareDnsSettingsInternalViewsResultToHclTerraform(struct?: DataCloudflareDnsSettingsInternalViewsResult): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareDnsSettingsInternalViewsResultOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareDnsSettingsInternalViewsResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareDnsSettingsInternalViewsResult | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareDnsSettingsInternalViewsResultList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataCloudflareDnsSettingsInternalViewsResultOutputReference {
    return new DataCloudflareDnsSettingsInternalViewsResultOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataCloudflareDnsSettingsInternalViews extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_dns_settings_internal_views";
  ...
  * @param importToId The construct id used in the generated config for the DataCloudflareDnsSettingsInternalViews to import
  * @param importFromId The id of the existing DataCloudflareDnsSettingsInternalViews that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/data-sources/dns_settings_internal_views#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataCloudflareDnsSettingsInternalViews to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_dns_settings_internal_views", importId: importFromId, provider });
      }
  ...
  * @param options DataCloudflareDnsSettingsInternalViewsConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareDnsSettingsInternalViewsConfig) {
    super(scope, id, {
      terraformResourceType: 'cloudflare_dns_settings_internal_views',
  ...
  private _name = new DataCloudflareDnsSettingsInternalViewsNameOutputReference(this, "name");
  public get name() {
    return this._name;
  }
  public putName(value: DataCloudflareDnsSettingsInternalViewsName) {
  ...
  private _result = new DataCloudflareDnsSettingsInternalViewsResultList(this, "result", false);
  public get result() {
    return this._result;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      name: dataCloudflareDnsSettingsInternalViewsNameToTerraform(this._name.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      name: {
        value: dataCloudflareDnsSettingsInternalViewsNameToHclTerraform(this._name.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataCloudflareDnsSettingsInternalViewsName",
      },
      order: {
