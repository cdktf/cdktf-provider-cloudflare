...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/data-sources/logpush_jobs
...
export class DataCloudflareLogpushJobs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareLogpushJobs that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/data-sources/logpush_jobs#import import section} in the documentation of this resource for the id to use
