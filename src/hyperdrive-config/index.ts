...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config
...
export interface HyperdriveConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#account_id HyperdriveConfig#account_id}
  */
  readonly accountId: string;
  /**
  * The caching details for the Hyperdrive configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#caching HyperdriveConfig#caching}
  */
  readonly caching?: HyperdriveConfigCaching;
  /**
  * The identifier of this resource. This is the hyperdrive config value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#id HyperdriveConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#name HyperdriveConfig#name}
  */
  readonly name: string;
  /**
  * The origin details for the Hyperdrive configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#origin HyperdriveConfig#origin}
  */
...
export interface HyperdriveConfigCaching {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#disabled HyperdriveConfig#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Configure the `max_age` value of this Hyperdrive configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#max_age HyperdriveConfig#max_age}
  */
  readonly maxAge?: number;
  /**
  * Disable caching for this Hyperdrive configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#stale_while_revalidate HyperdriveConfig#stale_while_revalidate}
  */
...
export interface HyperdriveConfigOrigin {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#access_client_id HyperdriveConfig#access_client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#access_client_secret HyperdriveConfig#access_client_secret}
  */
  readonly accessClientSecret?: string;
  /**
  * The name of your origin database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#database HyperdriveConfig#database}
  */
  readonly database: string;
  /**
  * The host (hostname or IP) of your origin database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#host HyperdriveConfig#host}
  */
  readonly host: string;
  /**
  * The password of the Hyperdrive configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#password HyperdriveConfig#password}
  */
  readonly password: string;
  /**
  * The port (default: 5432 for Postgres) of your origin database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#port HyperdriveConfig#port}
  */
  readonly port?: number;
  /**
  * Specifies the URL scheme used to connect to your origin database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#scheme HyperdriveConfig#scheme}
  */
  readonly scheme: string;
  /**
  * The user of your origin database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#user HyperdriveConfig#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config cloudflare_hyperdrive_config}
*/
export class HyperdriveConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HyperdriveConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/hyperdrive_config cloudflare_hyperdrive_config} Resource
  *
  * @param scope The scope in which to define this construct
