// https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/custom_hostname_fallback_origin
...
export class CustomHostnameFallbackOrigin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomHostnameFallbackOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/custom_hostname_fallback_origin#import import section} in the documentation of this resource for the id to use
