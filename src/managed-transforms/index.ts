...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/managed_transforms
...
export class ManagedTransforms extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedTransforms that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/managed_transforms#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/managed_transforms cloudflare_managed_transforms} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _managedRequestHeaders = new ManagedTransformsManagedRequestHeadersList(this, "managed_request_headers", true);
  ...
  private _managedResponseHeaders = new ManagedTransformsManagedResponseHeadersList(this, "managed_response_headers", true);
