...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.52.0/docs/resources/workers_for_platforms_namespace
...
export class WorkersForPlatformsNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkersForPlatformsNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.52.0/docs/resources/workers_for_platforms_namespace#import import section} in the documentation of this resource for the id to use
