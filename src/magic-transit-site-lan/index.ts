...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/magic_transit_site_lan
...
export class MagicTransitSiteLanNatOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // static_prefix - computed: true, optional: true, required: false
...
export class MagicTransitSiteLanRoutedSubnetsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // next_hop - computed: true, optional: false, required: true
...
export class MagicTransitSiteLanStaticAddressingDhcpServerOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // dhcp_pool_end - computed: true, optional: true, required: false
  ...
  // dhcp_pool_start - computed: true, optional: true, required: false
...
export class MagicTransitSiteLanStaticAddressingOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // virtual_address - computed: true, optional: true, required: false
...
export class MagicTransitSiteLan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MagicTransitSiteLan that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/magic_transit_site_lan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // routed_subnets - computed: true, optional: true, required: false
