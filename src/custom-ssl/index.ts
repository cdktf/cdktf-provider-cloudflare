...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl
...
export interface CustomSslConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#id CustomSsl#id}
  *
  ...
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#zone_id CustomSsl#zone_id}
  */
  readonly zoneId: string;
  /**
  * custom_ssl_options block
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#custom_ssl_options CustomSsl#custom_ssl_options}
  */
  readonly customSslOptions?: CustomSslCustomSslOptions;
  /**
  * custom_ssl_priority block
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#custom_ssl_priority CustomSsl#custom_ssl_priority}
  */
...
export interface CustomSslCustomSslOptions {
  ...
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#bundle_method CustomSsl#bundle_method}
  */
  readonly bundleMethod?: string;
  /**
  * Certificate certificate and the intermediate(s).
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#certificate CustomSsl#certificate}
  */
  readonly certificate?: string;
  /**
  * Specifies the region where your private key can be held locally. Available values: `us`, `eu`, `highest_security`.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#geo_restrictions CustomSsl#geo_restrictions}
  */
  readonly geoRestrictions?: string;
  /**
  * Certificate's private key.
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#private_key CustomSsl#private_key}
  */
  ...
  * 
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#type CustomSsl#type}
  */
...
export interface CustomSslCustomSslPriority {
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl#priority CustomSsl#priority}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl cloudflare_custom_ssl}
*/
export class CustomSsl extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/custom_ssl cloudflare_custom_ssl} Resource
  *
