// https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/tunnel_config
...
export class TunnelConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TunnelConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/tunnel_config#import import section} in the documentation of this resource for the id to use
