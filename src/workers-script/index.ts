...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.0/docs/resources/workers_script
...
export function workersScriptAssetsConfigToTerraform(struct?: WorkersScriptAssetsConfig | cdktf.IResolvable): any {
  ...
  return {
    _headers: cdktf.stringToTerraform(struct!.headers),
    _redirects: cdktf.stringToTerraform(struct!.redirects),
...
export class WorkersScriptAssetsConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // _headers - computed: false, optional: true, required: false
  private _headers?: string; 
  public get headers() {
    return this.getStringAttribute('_headers');
  }
  ...
  // _redirects - computed: false, optional: true, required: false
  private _redirects?: string; 
  public get redirects() {
    return this.getStringAttribute('_redirects');
  }
...
export class WorkersScript extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkersScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.0/docs/resources/workers_script#import import section} in the documentation of this resource for the id to use
