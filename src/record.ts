// https://www.terraform.io/docs/providers/cloudflare/r/record
...
export function recordTimeoutsToTerraform(struct?: RecordTimeoutsOutputReference | RecordTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RecordTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RecordTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: RecordTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
