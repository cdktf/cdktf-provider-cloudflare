// https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/tunnel_virtual_network
...
export class TunnelVirtualNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TunnelVirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/tunnel_virtual_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/tunnel_virtual_network cloudflare_tunnel_virtual_network} Resource
  *
  * @param scope The scope in which to define this construct
