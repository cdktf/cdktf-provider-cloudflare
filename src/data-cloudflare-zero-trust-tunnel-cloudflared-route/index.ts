// https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/data-sources/zero_trust_tunnel_cloudflared_route
...
export function dataCloudflareZeroTrustTunnelCloudflaredRouteFilterToTerraform(struct?: DataCloudflareZeroTrustTunnelCloudflaredRouteFilter | cdktf.IResolvable): any {
  ...
  return {
    ...
    tun_types: cdktf.stringToTerraform(struct!.tunTypes),
...
export function dataCloudflareZeroTrustTunnelCloudflaredRouteFilterToHclTerraform(struct?: DataCloudflareZeroTrustTunnelCloudflaredRouteFilter | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    tun_types: {
      value: cdktf.stringToHclTerraform(struct!.tunTypes),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class DataCloudflareZeroTrustTunnelCloudflaredRoute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustTunnelCloudflaredRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/data-sources/zero_trust_tunnel_cloudflared_route#import import section} in the documentation of this resource for the id to use
