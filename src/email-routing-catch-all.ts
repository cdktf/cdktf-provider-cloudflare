// https://www.terraform.io/docs/providers/cloudflare/r/email_routing_catch_all
...
export class EmailRoutingCatchAll extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/email_routing_catch_all cloudflare_email_routing_catch_all} Resource
  *
