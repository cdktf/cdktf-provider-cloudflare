...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/zero_trust_organization
...
export class ZeroTrustOrganizationCustomPagesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // forbidden - computed: true, optional: true, required: false
  ...
  // identity_denied - computed: true, optional: true, required: false
...
export class ZeroTrustOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/zero_trust_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/zero_trust_organization cloudflare_zero_trust_organization} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // custom_pages - computed: true, optional: true, required: false
  ...
  // login_design - computed: true, optional: true, required: false
