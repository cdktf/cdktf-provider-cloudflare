...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.24.0/docs/resources/worker_cron_trigger
...
export class WorkerCronTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkerCronTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.24.0/docs/resources/worker_cron_trigger#import import section} in the documentation of this resource for the id to use
