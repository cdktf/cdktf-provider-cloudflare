...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.10.1/docs/resources/origin_ca_certificate
...
export class OriginCaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OriginCaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.10.1/docs/resources/origin_ca_certificate#import import section} in the documentation of this resource for the id to use
