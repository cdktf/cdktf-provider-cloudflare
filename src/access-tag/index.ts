...
// https://registry.terraform.io/providers/cloudflare/cloudflare/4.43.0/docs/resources/access_tag
...
export class AccessTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.43.0/docs/resources/access_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.43.0/docs/resources/access_tag cloudflare_access_tag} Resource
  *
  * @param scope The scope in which to define this construct
