// https://registry.terraform.io/providers/cloudflare/cloudflare/4.48.0/docs/resources/zero_trust_split_tunnel
...
export class ZeroTrustSplitTunnel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustSplitTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.48.0/docs/resources/zero_trust_split_tunnel#import import section} in the documentation of this resource for the id to use
