// https://registry.terraform.io/providers/cloudflare/cloudflare/4.18.0/docs/resources/certificate_pack
...
export class CertificatePack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificatePack that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.18.0/docs/resources/certificate_pack#import import section} in the documentation of this resource for the id to use
