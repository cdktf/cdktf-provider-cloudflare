...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.6.0/docs/data-sources/email_security_block_senders
...
export class DataCloudflareEmailSecurityBlockSenders extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareEmailSecurityBlockSenders that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.6.0/docs/data-sources/email_security_block_senders#import import section} in the documentation of this resource for the id to use
