// https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/device_dex_test
...
export class DeviceDexTest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceDexTest that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/device_dex_test#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.46.0/docs/resources/device_dex_test cloudflare_device_dex_test} Resource
  *
  * @param scope The scope in which to define this construct
